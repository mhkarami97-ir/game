...
- [افزودن بازی جدید](#-افزودن-بازی-جدید)
- [بهبود کد](#-بهبود-کد)
...
### 3. 🛠️ افزودن بازی جدید
بازی جدیدی می‌خواهید؟ خودتان بسازید و اضافه کنید!
...
### 4. ساخت README.md برای بازی (اختیاری)
...
قبل از ارسال PR، بازی خود را تست کنید:
